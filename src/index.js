document.addEventListener("DOMContentLoaded", () => {
  ...
  function showQuestion() {
    ...
    const segments = ((quiz.currentQuestionIndex) / questions.length) * 100
    progressBar.style.width = `${segments}%`; // This value is hardcoded as a placeholder
  ...
  function nextButtonHandler() {
    ...
    const choiceEl = document.querySelectorAll('input[name="choice"]');
    ...
    choiceEl.forEach(radio => {
      if (radio.checked) {
        return selectedAnswer = radio.value;
